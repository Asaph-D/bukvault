...
VALUES
  ...
  ('30000000-0000-4000-a000-000000000004'::uuid,
   'aicha.mballa@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'Aïcha', 'Mballa', 'USER', true, NOW()),
  ('30000000-0000-4000-a000-000000000005'::uuid,
   'brice.owona@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'Brice', 'Owona', 'USER', true, NOW()),
  ('30000000-0000-4000-a000-000000000006'::uuid,
   'clarisse.ndjock@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'Clarisse', 'Ndjock', 'USER', true, NOW()),
  ('30000000-0000-4000-a000-000000000007'::uuid,
   'david.fouda@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'David', 'Fouda', 'USER', true, NOW()),
  ('30000000-0000-4000-a000-000000000008'::uuid,
   'estelle.kamga@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'Estelle', 'Kamga', 'USER', true, NOW()),
  ('30000000-0000-4000-a000-000000000009'::uuid,
   'fabrice.tchinda@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'Fabrice', 'Tchinda', 'USER', true, NOW()),
  ('30000000-0000-4000-a000-00000000000a'::uuid,
   'gisele.abega@users.cm',
   crypt('BukVault2026!', gen_salt('bf', 12)),
   'Gisèle', 'Abega', 'USER', true, NOW());
